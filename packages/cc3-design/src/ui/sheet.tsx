...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-background lg:p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
        ...
        left: 'inset-y-0 left-0 h-full w-11/12 md:w-3/4 max-w-[23.5rem] border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm',
        right:
...
export const Header = ({
  ...
  <div
    {...props}
    className={cn(
      'flex flex-col space-y-2 px-3 pt-6 lg:px-0 lg:pt-0',
      className,
    )}
  />
);
